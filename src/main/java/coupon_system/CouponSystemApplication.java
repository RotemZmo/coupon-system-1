...
public class CouponSystemApplication {
    ...
    static Company companyUpd = new Company(6, "comp666", "666", "comp666@gmail.com");
     ...
     * COUPON
     */
    static Coupon coupon = new Coupon("Coupon3", new Date(0), new Date(0), 10, CouponType.CAMPING, "coup", 10, "coup");
